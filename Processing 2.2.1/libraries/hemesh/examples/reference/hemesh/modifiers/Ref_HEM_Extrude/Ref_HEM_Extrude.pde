...
void draw() {
  ...
  fill(255);
  noStroke();
  render.drawFacesWithInternalLabel(1,mesh);//HEM_Extrude sets the internal label of all extruded faces to label 1
  fill(255,0,0);
  render.drawFacesWithInternalLabel(2,mesh);//HEM_Extrude sets the internal label of  all "wall" faces to label 2
  fill(250,120,120);
  render.drawFacesWithInternalLabel(3,mesh);//HEM_Extrude sets the internal label of  all fused faces to label 3
   fill(120,120,120);
  render.drawFacesWithInternalLabel(4,mesh);//HEM_Extrude sets the internal label of  all peaked faces to label 4
  stroke(0);
